...
Եթե դուք պետք է ծրագրավորմամբ գեներացնեք route-ներ երբ աշխատացնում եք ձեր ծրագիրը, դուք կարող եք դինամիկորեն ավելացնեք հայտարարությունները route-ների զանգվածին։ Օրինակի համար․
...
`$route` հատկությունը հիմա ռեակտիվ է, այնպես որ դուք կարող եք օգտագործել watcher որպեսզի route֊ի փոփոխությունները դարձնեք ռեակտիվ, այս կերպ․
