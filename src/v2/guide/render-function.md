...
Թարմացնելով բոլոր այս node֊երը արդյունավետորեն կարող է լինել դժվար, բայց բարեբախտորեն, դուք չպետք է այն ձեռքով անեք։ Փոխարենը, դուք պետք է տեղյակ պահեք Vue֊ին թե ինչ HTML էք դուք ցանկանում էջի վրա, template֊ում․
