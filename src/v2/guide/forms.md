...
Բայց երբեմն, մենք ցանկանում ենք կապել արժեքը դինամիկ հատկությանը Vue instance-ում։ Մենք կարող ենք օգտագործել `v-bind`-ը դրա համար։ Ի հավելումն, օգտագործելով `v-bind` թույլ է տալիս մեզ կապել input-ի արժեքը ոչ string արժեքներին։
